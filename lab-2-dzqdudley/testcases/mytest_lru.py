...
def switch_tests():
   ...
   # test case 2: a frame with unkown dst should be flooded to all port except ingress
    ...
    s.expect(PacketOutputEvent("eth0", reqpkt,"eth1", reqpkt, display=Ethernet), "Ethernet frame destined for 30:00:00:00:00:01 should be sent out to eth1 and eth0 because when sending eth2 replaced eth0") 
