...
def switch_tests():
   ...
   # test case 2: a frame with unkown dst should be flooded to all port except ingress
    ...
    # test case 4: sleep 
    s.expect(PacketInputTimeoutEvent(11),"sleep for 11s")

    # test case 5: after timeout, the record should be removed
    reqpkt = mk_pkt("30:00:00:00:00:01", "30:00:00:00:00:02", '192.168.100.1','192.168.100.2')
    s.expect(PacketInputEvent("eth0", reqpkt, display=Ethernet), "An Ethernet frame from 30:00:00:00:00:01 to 30:00:00:00:00:02 should arrive on eth0")
    s.expect(PacketOutputEvent("eth1", reqpkt,"eth2", reqpkt, display=Ethernet), "Ethernet frame destined for 30:00:00:00:00:02 should be floodto eth1 and eth2") 
